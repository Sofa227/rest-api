...
if (
    ...
    // устанавливаем значения свойств клиента
    ...
    if ($clients->create()) {
        ...
        echo json_encode(array("message" => "Клиент был создан."), JSON_UNESCAPED_UNICODE);
    }
    // если не удается создать товар, сообщим пользователю
        ...
        // сообщим пользователю
        echo json_encode(array("message" => "Невозможно создать клиента."), JSON_UNESCAPED_UNICODE);
    }
}
